...
console.log('Starting HubSpot Custom Object Practicum...');
...
app.get("/", async (req, res) => {
    const customObjectUrl = 'https://api.hubapi.com/crm/v3/objects/2-46913261?properties=language_name,description,primary_use_case';
    const headers = {
...
app.post('/update-cobj', async (req, res) => {
    const customObjectUrl = 'https://api.hubapi.com/crm/v3/objects/2-46913261';
    const headers = {
        Authorization: `Bearer ${PRIVATE_APP_ACCESS}`,
        'Content-Type': 'application/json'
    };
    ...
    const newObject = {
        properties: {
            ...
            primary_use_case: req.body.primary_use_case,
        }
    };
